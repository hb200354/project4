...
<div class="container">
  <div class="row">
    ...
    <div class="col-lg-8">
      <div class="card mb-4">
        <img class="card-img-top" src="assets/images/spring1.png" alt="봄 대표 여행지" />
        <div class="card-body">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="card mb-4">
            <img class="card-img-top" src="assets/images/spring2.jpg" alt="" />
            <div class="card-body">
        ...
        <div class="col-lg-6">
          <div class="card mb-4">
            <img class="card-img-top" src="assets/images/spring3.jpg" alt="" />
            <div class="card-body">
              <div class="small text-muted">봄 테마</div>
              <h2 class="card-title h4">여행지 준비 중</h2>
              <p class="card-text">곧 업데이트될 예정입니다.</p>
